          ...
          <Carousel.Item interval={3000}>
            ...
            <Carousel.Caption>
              ...
              <h5>
                ...
                <Badge bg='dark' text='light'> Where Banking Become Easy. </Badge>
              </h5>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item interval={3000}>
            <img className={classes.center} src={image2} alt="First slide" />
            <Carousel.Caption>
              <h3>
                <Badge bd="primary">Easy as a Selfie!.</Badge>
              </h3>
              <Button variant='dark' as={Link} to="/AllUsers">Transfer.</Button>
              <p>Transfer with just two clicks!</p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item interval={3000}>
            <img className={classes.center} src={image3} alt="Second slide" />

            <Carousel.Caption>
              <h3>
                <Badge>New features</Badge>
              </h3>
              <Button variant='dark' as={Link} to='/History-Trans'>History</Button>
